	...
	function shopper_credit() {
		...
		<div class="site-info">
			...
			<?php if ( apply_filters( 'shopper_credit_link', true ) ) { ?>
				<?php printf( esc_attr__( ' %1$s Designed by %2$s.', 'shopper' ), 'Shopper', '<a href="https://shopperwp.io" title="Shopper - The Best Free WooCommerce for WordPress" rel="author">ShopperWP</a>' ); ?>
			<?php } ?>
